...
public class BasePage {
	...
	public static WebElement webdriverwaitForElement(String xpathValue) {
		WebElement element = new WebDriverWait(environment.driver, Duration.ofSeconds(20)).
	...
	public static List<WebElement> webdriverwaitForElements(String xpathValue) {
		List<WebElement> elements = new WebDriverWait(environment.driver, Duration.ofSeconds(20)).
